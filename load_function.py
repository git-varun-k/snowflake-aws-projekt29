...
def album(data):
    ...
    for row in data['items']:
        ...
        album_name = f'"{album_name}"' if ',' in album_name else album_name
        ...
        for key, value in row.items():
            if key == 'track':
                for artist in value['artists']:
                    artist_dict = { 'artist_id': artist['id'], 'artist_name' : f'"{artist['name']}"' if ',' in artist['name'] else artist['name'], 'external_url': artist['href']}
